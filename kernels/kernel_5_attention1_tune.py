...
def main():
    ...
    #print best config. for attention kernel 1
    print(attn_fwd_pass1.best_config)
    #best config. on A4000: BLOCK_M: 64, BLOCK_N: 32, BLOCK_D: 32, num_warps: 2, num_ctas: 1, num_stages: 2, maxnreg: None
